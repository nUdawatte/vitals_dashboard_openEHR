(() => {
  ...
  var EventEmitter = class {
    ...
    emit(eventOptions) {
      const eventTarget = new CustomEvent(this.eventName, __spreadValues({
        bubbles: true,
        cancelable: true,
        composed: true,
        detail: {}
  ...
  __decorateClass([
    property({ type: String, reflect: true })
  ], EhrElement.prototype, "repeatprefix", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], EhrElement.prototype, "repeatsuffix", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], EhrElement.prototype, "variant", 2);
  __decorateClass([
    property({ type: Function })
  ], EhrElement.prototype, "handleSearch", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ...
  __decorateClass([
    event("mb-disconnect")
  ], EhrElement.prototype, "_mbDisconnect", 2);
  __decorateClass([
    watch("path")
      ...
      if (path !== "") {
        ...
        if (typeof value === "object") {
          if (Array.isArray(value)) {
            multipleSelectArray(value, path, flat, ehrElement == null ? void 0 : ehrElement.repeatprefix, ehrElement == null ? void 0 : ehrElement.repeatsuffix);
          } else {
  ...
  function toInsertContext(path, nonNullPaths, mbElements) {
    ...
    const repeatableElementPaths = Object.keys(mbElements).filter((key) => {
      var _a2;
      return (_a2 = mbElements[key]) == null ? void 0 : _a2.multiple;
    }).flatMap((pathKey) => {
      const el = mbElements[pathKey];
      const data = el == null ? void 0 : el.data;
  ...
  // src/medblocks/repeat/Repeatable.ts
  ...
  ], Repeatable.prototype, "count", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], Repeatable.prototype, "path", 2);
  __decorateClass([
    event("mb-count")
  ], Repeatable.prototype, "_mbCount", 2);
  __decorateClass([
    event("mb-connect-repeatable")
  ], Repeatable.prototype, "_mbConnectRepeatable", 2);
  __decorateClass([
    watch("count")
  ], Repeatable.prototype, "handleCountChange", 1);
  ...
  var MedblockForm = class extends LitElement {
    constructor() {
      ...
      this.handleParentMessage = (e6) => {
        var _a2, _b;
        const message = e6 == null ? void 0 : e6.data;
        if ((message == null ? void 0 : message.type) === "mb-suggestion") {
          const suggestion = (_a2 = message == null ? void 0 : message.data) == null ? void 0 : _a2.suggestion;
          const templateId = (_b = message == null ? void 0 : message.data) == null ? void 0 : _b.templateId;
    ...
    serialize(mbElements = this.mbElements) {
      const toSerialize = this.serializeDeferredData ? __spreadValues(__spreadValues({}, mbElements), this.dataToContextElements(this.deferredData)) : mbElements;
    ...
    isContextElement(element) {
      return (element == null ? void 0 : element.autocontext) != null;
    }
    nonEmptyPaths() {
    ...
    nonContextPaths() {
      return Object.keys(this.mbElements).filter((k2) => {
        var _a2;
        return ((_a2 = this.mbElements[k2]) == null ? void 0 : _a2.autocontext) == null;
      });
    }
    insertContext() {
      ...
      Object.values(this.mbElements).filter((element) => !!element.autocontext).forEach((element) => {
        ...
        if (valueToInsert != null) {
          const contextData = this.overwritectx ? this.plugin.getContext(path, this.ctx, nonNullPaths, this.mbElements) : (_a2 = element.data) != null ? _a2 : this.plugin.getContext(path, this.ctx, nonNullPaths, this.mbElements);
    ...
    getCount(pathString, data) {
      ...
      const matches = keys.map((path) => {
        ...
        regex.lastIndex = 0;
        return match;
      }).map((match) => match == null ? void 0 : match[2]).filter((match) => match).map((str) => str && parseInt(str, 10));
      if (matches.length === 0) {
        return 0;
      }
    ...
    set data(data) {
      ...
      if (inDataButNotElements.length > 0) {
        ...
        this.deferredData = __spreadValues(__spreadValues({}, this.deferredData), object);
      }
      this.sendWebMessage();
    }
    ...
    handleChildConnect(e6) {
      ...
      if (this.deferredData[path] != null) {
        const _a2 = this.deferredData, { [path]: data } = _a2, excluded = __objRest(_a2, [__restKey(path)]);
    ...
    addSuggestion(data) {
      const suggestElements = Object.keys(data).map((key) => {
        ...
        return {
          key,
          suggest: (_a2 = this.mbElements[key]) == null ? void 0 : _a2.parentElement
        };
      }).filter(({ suggest }) => (suggest == null ? void 0 : suggest.nodeName) === "MB-SUGGEST");
  ...
  __decorateClass([
    property({ type: String, reflect: true })
  ], MedblockForm.prototype, "templateId", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MedblockForm.prototype, "nosuggest", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MedblockForm.prototype, "variant", 2);
  __decorateClass([
    property({ type: Function })
  ], MedblockForm.prototype, "handleSearch", 2);
  __decorateClass([
    watch("variant")
  ], MedblockForm.prototype, "handleVariantChange", 1);
  __decorateClass([
    watch("handleSearch")
  ], MedblockForm.prototype, "handleSearchChange", 1);
  __decorateClass([
    event("mb-input")
  ], MedblockForm.prototype, "_input", 2);
  __decorateClass([
    event("mb-load")
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MedblockForm.prototype, "serializeDeferredData", 2);
  __decorateClass([
    state()
  ], MedblockForm.prototype, "mbElementSet", 2);
  __decorateClass([
    state()
  ], MedblockForm.prototype, "repeatables", 2);
  __decorateClass([
    state()
  ], MedblockForm.prototype, "updates", 2);
  __decorateClass([
    event("mb-submit")
  ], MedblockForm.prototype, "submit", 2);
  __decorateClass([
    state()
  ], MedblockForm.prototype, "deferredData", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MedblockForm.prototype, "suggestDomain", 2);
  __decorateClass([
    state()
  ], MedblockForm.prototype, "observer", 2);
  __decorateClass([
    state()
  ], MedblockForm.prototype, "intervalId", 2);
  ...
  var transformations = {
    DV_QUANTITY: (n6) => {
      ...
      return [
        {
          name: "Quantity",
          html: `<mb-quantity default="${((_d = (_c = (_b = (_a2 = n6 == null ? void 0 : n6.inputs) == null ? void 0 : _a2[1]) == null ? void 0 : _b.list) == null ? void 0 : _c[0]) == null ? void 0 : _d.value) || ""}" path="${n6.path}" label="${n6.name}">
                  ${n6.inputs && n6.inputs[1] && n6.inputs[1].list ? n6.inputs[1].list.map((unit) => {
            var _a3, _b2, _c2, _d2;
            return `<mb-unit unit="${unit == null ? void 0 : unit.value}" label="${(unit == null ? void 0 : unit.label) || ""}" min="${((_b2 = (_a3 = unit == null ? void 0 : unit.validation) == null ? void 0 : _a3.range) == null ? void 0 : _b2.min) || ""}" max="${((_d2 = (_c2 = unit == null ? void 0 : unit.validation) == null ? void 0 : _c2.range) == null ? void 0 : _d2.max) || ""}"></mb-unit>`;
          }).join("\n") : ""}
              </mb-quantity>`
        }
      ];
      ...
      if (n6.max === -1) {
        ...
        ${n6.inputs && n6.inputs[0] && n6.inputs[0].list ? n6.inputs[0].list.map((option) => `<mb-option value="${option.value}" label="${option.label}"></mb-option>`).join("\n") : ""}
          ...
          },
          {
            ...
            html: `<mb-search-multiple disablefallback path="${n6.path.slice(0, n6.path.length - 2)}" label="${n6.name || ""}" terminology="${n6.inputs[0].terminology || ((_a2 = n6 == null ? void 0 : n6.annotations) == null ? void 0 : _a2.MB_VALUESET) || "local"}">
        </mb-search-multiple>`
          }
        ];
      } else {
        ...
        ${n6.inputs && n6.inputs[0] && n6.inputs[0].list ? n6.inputs[0].list.map((option) => `<mb-option value="${option.value}" label="${option.label}"></mb-option>`).join("\n") : ""}
          ...
          {
            name: "Search",
            html: `<mb-search disablefallback path="${n6.path}" label="${n6.name || ""}" terminology="${n6.inputs[0].terminology || ((_b = n6 == null ? void 0 : n6.annotations) == null ? void 0 : _b.MB_VALUESET) || "local"}">
        </mb-search>`
          }
        ];
      }
    ...
    DV_PROPORTION: (n6) => {
      var _a2, _b;
      return [
        ...((_a2 = n6.proportionTypes) == null ? void 0 : _a2.some((props) => props === "percent")) ? [
          {
            name: "Percent",
            html: `<mb-proportion path="${n6.path}" label="${n6.name || ""}" min="0" max="100" step="1" type="percent"></mb-proportion>`
          }
        ] : [],
        ...((_b = n6.proportionTypes) == null ? void 0 : _b.some((props) => props === "unitary")) ? [
          {
            name: "Unitary",
    ...
    DV_TEXT: (n6) => {
      ...
      if (n6.max === -1) {
        templates = [
          ...((_a2 = n6 == null ? void 0 : n6.annotations) == null ? void 0 : _a2.MB_VALUESET) ? [
            {
              name: "Search-Multiple",
              html: `<mb-search-multiple path="${n6.path.slice(0, n6.path.length - 2)}" label="${n6.name || ""}" terminology="${(_b = n6 == null ? void 0 : n6.annotations) == null ? void 0 : _b.MB_VALUESET}">
                </mb-search-multiple>`
            }
          ] : [],
          {
        ...
        templates = [
          ...((_c = n6 == null ? void 0 : n6.annotations) == null ? void 0 : _c.MB_VALUESET) ? [
            {
              name: "Search",
              html: `<mb-search path="${n6.path}" label="${n6.name || ""}" terminology="${(_d = n6 == null ? void 0 : n6.annotations) == null ? void 0 : _d.MB_VALUESET}">
            </mb-search>`
            }
          ] : [],
          {
  ...
  // src/medblocks/form/autoform-utils.ts
  var storageAPI = {
  ...
  function encodeText(value) {
    ...
    const ap = /'/g;
    const ic = /"/g;
    const val = value == null ? void 0 : value.toString().replace(lt, "&lt;").replace(gt, "&gt;").replace(ap, "&#39;").replace(ic, "&#34;");
    return val;
  }
  function stripIndex(string) {
    const id = string == null ? void 0 : string.split(":");
    id.pop();
  ...
  function getDefaultTransform(node, index = 0) {
    ...
    return (_a2 = results[index]) == null ? void 0 : _a2.html;
  }
  ...
  function setupButtons(cloneDiv, originalDiv, handleSearch, config) {
    ...
    for (const buttons of addButtons) {
      const parentNode = (_a2 = buttons == null ? void 0 : buttons.parentNode) == null ? void 0 : _a2.parentNode;
      addButtonEventListener(buttons, parentNode, handleSearch, config);
    }
    const deleteButtons = cloneDiv == null ? void 0 : cloneDiv.querySelectorAll(".deleteButton");
    ...
    const currentDivButtons = originalDiv == null ? void 0 : originalDiv.querySelectorAll(".divButton");
  ...
  function processChildDiv(childDiv, baseIdPath, handleSearch) {
    ...
    if (firstChild) {
      ...
      if ((firstChild == null ? void 0 : firstChild.tagName) === "MB-SEARCH" || (firstChild == null ? void 0 : firstChild.tagName) === "MB-SEARCH-MULTIPLE") {
  ...
  function deleteButtonEventListener(button) {
    button == null ? void 0 : button.addEventListener("click", (e6) => {
      var _a2, _b, _c, _d;
      e6.stopPropagation();
      const currentNode = (_a2 = button.parentNode) == null ? void 0 : _a2.parentNode;
      const splitArray = (_b = currentNode == null ? void 0 : currentNode.id) == null ? void 0 : _b.split(":");
      const length = splitArray.length - 1;
      splitArray[length] = `${Number(splitArray[length]) - 1}`;
      const divId = splitArray.join(":");
      const children = (_c = currentNode == null ? void 0 : currentNode.parentNode) == null ? void 0 : _c.children;
      ...
      targetDivButton == null ? void 0 : targetDivButton.classList.remove("hidden");
      (_d = currentNode == null ? void 0 : currentNode.parentNode) == null ? void 0 : _d.removeChild(currentNode);
    });
  }
  function treeChildrenPTag(tree, div, depth) {
    if (tree.rmType !== "COMPOSITION" && tree.rmType !== "EVENT_CONTEXT" && tree.rmType !== "ISM_TRANSITION") {
      ...
      div == null ? void 0 : div.appendChild(p2);
    }
  }
  function noChildrenCondition(tree, div, handleSearch, config) {
    ...
    if ((innerDiv == null ? void 0 : innerDiv.tagName) === "MB-SEARCH" || (innerDiv == null ? void 0 : innerDiv.tagName) === "MB-SEARCH-MULTIPLE") {
      innerDiv.handleSearch = handleSearch;
    }
    if ((innerDiv == null ? void 0 : innerDiv.tagName) === "MB-MULTIMEDIA") {
      handleMediaPlugin(innerDiv);
    }
    if ((innerDiv == null ? void 0 : innerDiv.tagName) === "MB-INPUT" && ((_a2 = config == null ? void 0 : config.TEXT_AREA) == null ? void 0 : _a2.includes(innerDiv.path)))
      innerDiv.textarea = true;
  }
  function runAddEventListener(div, handleSearch, config) {
    var _a2, _b;
    let elementId = stripIndex(div == null ? void 0 : div.id);
    const children = (_a2 = div == null ? void 0 : div.parentNode) == null ? void 0 : _a2.children;
    ...
    const pTagArray = (_b = pTag == null ? void 0 : pTag.textContent) == null ? void 0 : _b.split(".");
    pTagArray[0] = `${(divsWithPrefix == null ? void 0 : divsWithPrefix.length) + 1}`;
    pTag.textContent = pTagArray.join(" . ");
    setupButtons(cloneDiv, div, handleSearch, config);
    const parentNode = div == null ? void 0 : div.parentNode;
    parentNode == null ? void 0 : parentNode.insertBefore(cloneDiv, div.nextSibling);
  }
  function addMBRepeatables(tree, container) {
    if (!(tree == null ? void 0 : tree.path) || !tree.mbElement || !container)
      return;
    ...
    fragment == null ? void 0 : fragment.appendChild(newDiv);
  ...
  function traverse(tree, container, document2, reference, handleSearch, config, depth = -1) {
    ...
    if (!tree || !document2)
      return;
    if (!tree.path || !((_a2 = tree.children) == null ? void 0 : _a2.length) && !tree.mbElement)
      return;
    const fragment = document2.createDocumentFragment();
    const div = fragment == null ? void 0 : fragment.appendChild(document2.createElement("div"));
    div.id = encodeText(tree.path);
    if (tree.max === -1 && ((_b = tree.children) == null ? void 0 : _b.length)) {
      addMBRepeatables(tree, container);
      treeChildrenPTag(tree, div, depth + 1);
      const pTag = div.querySelector("p");
      pTag == null ? void 0 : pTag.classList.add("label");
    ...
    } else if ((_c = tree.children) == null ? void 0 : _c.length) {
      treeChildrenPTag(tree, div, depth + 1);
      for (const child of tree.children || []) {
        traverse(child, div, document2, reference, handleSearch, config, depth + 1);
      }
  ...
  function handleLeafNode(node) {
    ...
    if (node.inContext) {
      ...
      const lists = (_a2 = node.inputs.find((input) => input.suffix === "code")) == null ? void 0 : _a2.list;
    ...
    } else if ((_b = node == null ? void 0 : node.path) == null ? void 0 : _b.endsWith("expiry_time")) {
  ...
  function addIgniteContext(node) {
    var _a2, _b, _c;
    const contextNode = (_a2 = node == null ? void 0 : node.children) == null ? void 0 : _a2.find((n6) => (n6 == null ? void 0 : n6.id) === "context");
    (_b = contextNode == null ? void 0 : contextNode.children) == null ? void 0 : _b.push(healthCareFacilityContextNode);
    (_c = contextNode == null ? void 0 : contextNode.children) == null ? void 0 : _c.push(participationContextNode);
    return node;
  }
  function addPathToChildren(node, parentPath = "") {
    node.path = parentPath === "" ? node == null ? void 0 : node.id : `${parentPath}/${node == null ? void 0 : node.id}`;
    if ((node == null ? void 0 : node.max) === -1)
      node.path += ":0";
    if (node == null ? void 0 : node.children)
      for (const child of node.children) {
        addPathToChildren(child, `${node == null ? void 0 : node.path}`);
      }
    return node;
  }
  ...
  function addMbElements(node) {
    ...
    if (!node)
      return node;
    if ((_a2 = node == null ? void 0 : node.children) == null ? void 0 : _a2.length) {
  ...
  function createAutoFormTree(webTemplate, addContext = false) {
    const baseTree = webTemplate == null ? void 0 : webTemplate.tree;
  ...
  function bindRepeatables(mbRepeatables, repeatableArray, formNode, composition, handleSearch, config) {
    ...
    for (const repeatable of repeatableArray) {
      ...
      const parentNode = (_a2 = repeatable.parentNode) == null ? void 0 : _a2.parentNode;
      for (let j = 1; j < countIndex; j++) {
        requestAnimationFrame(() => {
          var _a3;
          const divsWithPrefix = Array.from(parentNode == null ? void 0 : parentNode.children).filter((child) => child.tagName.toLowerCase() === "div" && child.id.startsWith(path) && child.className !== "repeatables");
          const targetDiv = divsWithPrefix[divsWithPrefix.length - 1];
          const addButtons = targetDiv == null ? void 0 : targetDiv.querySelectorAll(".addButton");
          const targetAddButton = addButtons == null ? void 0 : addButtons[(addButtons == null ? void 0 : addButtons.length) - 1];
          const buttonParentNode = (_a3 = targetAddButton == null ? void 0 : targetAddButton.parentNode) == null ? void 0 : _a3.parentNode;
          runAddEventListener(buttonParentNode, handleSearch, config);
        });
      }
    }
    requestAnimationFrame(() => {
      const newMbRepeatables = formNode == null ? void 0 : formNode.querySelectorAll("mb-repeatable-headless");
  ...
  // src/medblocks/form/autoForm.ts
  var MedblocksAutoForm = class extends LitElement {
    constructor() {
      super(...arguments);
      this.templateId = "";
      this.ctx = {};
  ...
  __decorateClass([
    property({ type: String, reflect: true })
  ], MedblocksAutoForm.prototype, "templateId", 2);
  __decorateClass([
    property({ type: Object })
  ], MedblocksAutoForm.prototype, "ctx", 2);
  __decorateClass([
    property({ type: Object })
  ], MedblocksAutoForm.prototype, "config", 2);
  __decorateClass([
    property({ type: Object })
  ], MedblocksAutoForm.prototype, "webTemplate", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MedblocksAutoForm.prototype, "variant", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MedblocksAutoForm.prototype, "addContext", 2);
  __decorateClass([
    property({ type: Function })
  ], MedblocksAutoForm.prototype, "handleSearch", 2);
  __decorateClass([
    watch("webTemplate")
  ], MedblocksAutoForm.prototype, "generateAutoForm", 1);
  MedblocksAutoForm = __decorateClass([
...
`;
  ...
  var i3 = (i32, e42) => e42.kind === "method" && e42.descriptor && !("value" in e42.descriptor) ? __spreadProps2(__spreadValues2({}, e42), { finisher(n32) {
  ...
  function t3(t22) {
    return e4(__spreadProps2(__spreadValues2({}, t22), { state: true }));
  }
  var o5 = ({ finisher: e42, descriptor: t22 }) => (o23, n32) => {
    var r6;
    if (n32 === void 0) {
      const n42 = (r6 = o23.originalKey) !== null && r6 !== void 0 ? r6 : o23.key, i32 = t22 != null ? { kind: "method", placement: "prototype", key: n42, descriptor: t22(o23.key) } : __spreadProps2(__spreadValues2({}, o23), { key: n42 });
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.HQSLB26P.js
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.2ZCLEOHE.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.X2HKYC6R.js
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.GX6HO7XH.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.TYK5CQ2Z.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.TGQTNU23.js
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.6Q6RSBMS.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.FITQ3IRS.js
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.M72JNJAN.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.OTJEEAQN.js
  ...
  SlMenuLabel = __decorateClass2([
    n5("sl-menu-label")
  ], SlMenuLabel);

  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.4SHATWZF.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.LFCTWBU7.js
  ...
  var computePosition = async (reference, floating, config) => {
    ...
    for (let i5 = 0; i5 < middleware.length; i5++) {
      ...
      middlewareData = __spreadProps2(__spreadValues2({}, middlewareData), {
        [name]: __spreadValues2(__spreadValues2({}, middlewareData[name]), data)
      });
      if (reset) {
  ...
  async function detectOverflow(middlewareArguments, options) {
    ...
    const elementClientRect = rectToClientRect(platform2.convertOffsetParentRelativeRectToViewportRelativeRect ? await platform2.convertOffsetParentRelativeRectToViewportRelativeRect({
      rect: elementContext === "floating" ? __spreadProps2(__spreadValues2({}, rects.floating), {
        x: x2,
        y: y2
      }) : rects.reference,
  ...
  function convertValueToCoords(placement, rects, value, rtl) {
    ...
    const rawValue = typeof value === "function" ? value(__spreadProps2(__spreadValues2({}, rects), {
      placement
    })) : value;
    const {
      mainAxis,
  ...
  var shift = function(options) {
    ...
    return {
      ...
      async fn(middlewareArguments) {
        ...
        const limitedCoords = limiter.fn(__spreadProps2(__spreadValues2({}, middlewareArguments), {
          [mainAxis]: mainAxisCoord,
          [crossAxis]: crossAxisCoord
        }));
        return __spreadProps2(__spreadValues2({}, limitedCoords), {
          data: {
  ...
  var size = function(options) {
    ...
    return {
      ...
      async fn(middlewareArguments) {
        ...
        apply == null ? void 0 : apply(__spreadValues2(__spreadValues2({}, dimensions), rects));
        return {
          reset: {
            rects: true
          }
  ...
  var platform = {
    ...
    getElementRects: (_ref) => {
      ...
      return {
        ...
        floating: __spreadProps2(__spreadValues2({}, getDimensions(floating)), {
          x: 0,
          y: 0
        })
      };
  ...
  var computePosition2 = (reference, floating, options) => computePosition(reference, floating, __spreadValues2({
    platform
  }, options));
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.QDIDEMYF.js
  ...
  var MbDropDown = class extends SlDropdown {
    handleTriggerClick() {
    ...
    handleTriggerKeyDown(event2) {
      ...
      if (["ArrowDown", "ArrowUp"].includes(event2.key)) {
        ...
        if (event2.key === "ArrowDown" && firstMenuItem) {
          menu == null ? void 0 : menu.setCurrentItem(firstMenuItem);
          firstMenuItem.focus();
          return;
        }
        if (event2.key === "ArrowUp" && lastMenuItem) {
          menu == null ? void 0 : menu.setCurrentItem(lastMenuItem);
          lastMenuItem.focus();
        }
      }
    }
  ...
  __decorateClass([
    property()
  ], MbDropDown.prototype, "searchElement", 2);
  MbDropDown = __decorateClass([
    customElement("mb-dropdown")
  ], MbDropDown);

  // src/medblocks/codedtext/abstractSearch.ts
  var MbSearchAbstract = class extends CodedTextElement {
    ...
    reportValidity() {
      var _a2, _b;
      const input = (_a2 = this.shadowRoot) == null ? void 0 : _a2.querySelector("sl-input");
      if (this.searchTerm) {
        input.setCustomValidity("Please select a value from dropdown");
        return input.reportValidity();
      }
      if (typeof this.data !== "string" && ((_b = this.data) == null ? void 0 : _b.length))
        return true;
      return input.reportValidity();
    }
    _showResults() {
      ...
      >
        ...
        ${this._showResults() ? html`
              <sl-menu style="min-width:300px; width:fit-content;">
                ...
                ${((_c = this._filters) == null ? void 0 : _c.length) > 0 && !this.fixfilters ? html` <sl-divider></sl-divider>
    ...
    get _hasValue() {
      var _a2, _b;
      return !!(((_a2 = this == null ? void 0 : this.data) == null ? void 0 : _a2.value) && ((_b = this == null ? void 0 : this.data) == null ? void 0 : _b.code) || typeof this.data === "string" && this.data !== "");
    }
    get _display() {
      var _a2;
  ...
  __decorateClass([
    property({ type: String })
  ], MbSearchAbstract.prototype, "searchTerm", 2);
  __decorateClass([
    property({ type: Boolean })
  ], MbSearchAbstract.prototype, "show", 2);
  __decorateClass([
    property({ type: Array })
  ], MbSearchAbstract.prototype, "_filters", 2);
  __decorateClass([
    property({ type: Array })
  ], MbSearchAbstract.prototype, "_cancelledFilters", 2);
  __decorateClass([
    property({ type: Array })
  ], MbSearchAbstract.prototype, "mock", 2);
  __decorateClass([
    property({ type: Number })
  ], MbSearchAbstract.prototype, "debounceInterval", 2);
  __decorateClass([
    property({ type: Number })
  ], MbSearchAbstract.prototype, "hits", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbSearchAbstract.prototype, "placeholder", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbSearchAbstract.prototype, "id", 2);
  __decorateClass([
    property({ type: String })
  ], MbSearchAbstract.prototype, "textFallbackLabel", 2);
  __decorateClass([
    property({ type: String })
  ], MbSearchAbstract.prototype, "filtersLabel", 2);
  __decorateClass([
    property({ type: String })
  ], MbSearchAbstract.prototype, "errorMessage", 2);
  __decorateClass([
    property({ type: Boolean })
  ], MbSearchAbstract.prototype, "disablefallback", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbSearchAbstract.prototype, "disablesearch", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbSearchAbstract.prototype, "required", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbSearchAbstract.prototype, "hoist", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbSearchAbstract.prototype, "fixfilters", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbSearchAbstract.prototype, "disabled", 2);
  __decorateClass([
    property({ type: String, attribute: "filter-type", reflect: true })
  ], MbSearchAbstract.prototype, "filterType", 2);
  __decorateClass([
    state()
  ], MbSearchAbstract.prototype, "_moreHits", 2);
  __decorateClass([
    state()
  ], MbSearchAbstract.prototype, "_debouncing", 2);
  __decorateClass([
    state()
  ], MbSearchAbstract.prototype, "_debounceTimeout", 2);
  __decorateClass([
    watch("searchTerm")
  ], MbSearchAbstract.prototype, "_searchTermChange", 1);
  __decorateClass([
    event("mb-search")
  ], MbSearchAbstract.prototype, "_mbSearch", 2);
  __decorateClass([
    query("mb-dropdown")
  ], MbSearchAbstract.prototype, "dropdown", 2);

  // src/medblocks/codedtext/search.ts
  var MbSearch = class extends MbSearchAbstract {
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.LAAROFAU.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.24E5KUVH.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.ZHPXFQWE.js
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.PJFWJ67S.js
  ...
  var MbSelect = class extends CodedTextElement {
    ...
    handleInput(e6) {
      ...
      if (select.value && typeof select.value === "object") {
        const data = select.value.map((item) => {
          ...
          if (ordinal) {
            codedtext = __spreadProps(__spreadValues({}, codedtext), { ordinal });
          }
          return codedtext;
        });
        ...
        if (ordinal) {
          data = __spreadProps(__spreadValues({}, data), { ordinal });
        }
        this.data = data;
        this._mbInput.emit();
      }
    ...
    reportValidity() {
      var _a2;
      const select = (_a2 = this.shadowRoot) == null ? void 0 : _a2.querySelector("sl-select");
    ...
    getTextData(data) {
      if (data == null)
        return "";
      if (Array.isArray(data))
        return (data == null ? void 0 : data.map((item) => item.value || "").join(", ")) || "";
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbSelect.prototype, "hoist", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbSelect.prototype, "disabled", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbSelect.prototype, "nonclearable", 2);
  __decorateClass([
    state()
  ...
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbOption.prototype, "display", 2);
  __decorateClass([
    property({ type: Number, reflect: true })
  ], MbOption.prototype, "ordinal", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbOption.prototype, "type", 2);
  MbOption = __decorateClass([
    customElement("mb-option")
  ], MbOption);

  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.WVVUWAAN.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.O2TDYW3A.js
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.IEE4AKXF.js
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.N2MV4HXO.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.5D7IFRWW.js
  ...
  var MbInput = class extends EhrElement {
    ...
    reportValidity() {
      ...
      let input = null;
      if (this.textarea) {
        input = (_a2 = this.shadowRoot) == null ? void 0 : _a2.querySelector("sl-textarea");
      } else {
        input = (_b = this.shadowRoot) == null ? void 0 : _b.querySelector("sl-input");
      }
      return input.reportValidity();
    }
    render() {
  ...
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbInput.prototype, "placeholder", 2);
  __decorateClass([
    property({ type: Number, reflect: true })
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbInput.prototype, "disabled", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbInput.prototype, "autocomplete", 2);
  __decorateClass([
    property({ type: String })
  ], MbInput.prototype, "rows", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbInput.prototype, "resize", 2);
  __decorateClass([
    event("mb-input")
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.PHWU4VVX.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.VDRCOTCD.js
  ...
  var CodedTextButtons = class extends CodedTextElement {
    ...
    _handleInput(option) {
      ...
      if (option.ordinal) {
        data = __spreadProps(__spreadValues({}, data), { ordinal: option.ordinal });
      }
      if (((_a2 = this.data) == null ? void 0 : _a2.code) === data.code) {
        this.data = void 0;
      } else {
        this.data = data;
      }
    ...
    getVariant(option) {
      var _a2;
      if (((_a2 = this.data) == null ? void 0 : _a2.code) === option.value) {
        return "primary";
      }
      if (option.type)
        return option.type;
    ...
    render() {
      ...
      if (this.variant === "text") {
        return html`<div>
        ${this._label()}
        <p>${((_a2 = this.data) == null ? void 0 : _a2.value) || "-"}</p>
      </div>`;
      }
      return html`
      <div style="position:relative;z-index:2" part="base">
        ...
        <input
          .value=${((_b = this.data) == null ? void 0 : _b.code) || ""}
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], CodedTextButtons.prototype, "disabled", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], CodedTextButtons.prototype, "id", 2);
  __decorateClass([
    state()
  ...
  // src/medblocks/codedtext/buttons-multiple.ts
  var CodedTextButtons2 = class extends CodedTextElement {
    constructor() {
      super(...arguments);
      this.required = false;
      this.disabled = false;
    ...
    valueExists(code) {
      var _a2;
      return (_a2 = this.data) == null ? void 0 : _a2.some((el) => el.code === code);
    }
    addValue() {
      var _a2;
      if (this.data == null)
      ...
      if (this.valueExists(this.value.code)) {
        this.data = (_a2 = this.data) == null ? void 0 : _a2.filter((d2) => d2.code !== this.value.code);
      } else {
    ...
    render() {
      ...
      if (this.variant === "text") {
        ...
        ${this._label()}
        <p>
          ${((_a2 = this.data) == null ? void 0 : _a2.map((item) => (item == null ? void 0 : item.value) || "").join(", ")) || ""}
        </p>
      </div>`;
      }
      return html`
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], CodedTextButtons2.prototype, "required", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], CodedTextButtons2.prototype, "disabled", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], CodedTextButtons2.prototype, "multiple", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], CodedTextButtons2.prototype, "id", 2);
  __decorateClass([
    state()
  ], CodedTextButtons2.prototype, "_options", 2);
  __decorateClass([
    state()
  ], CodedTextButtons2.prototype, "value", 2);
  CodedTextButtons2 = __decorateClass([
  ...
  var MbQuantity = class extends QuantityElement {
    ...
    handleChildChange() {
      ...
      if ((_a2 = this.data) == null ? void 0 : _a2.unit) {
        unitToUse = this.data.unit;
      }
      const selectedUnit = unitToUse && this.units.find((unit) => unit.unit === unitToUse) || this.units[0];
      if (selectedUnit) {
        this.min = (_b = selectedUnit.min) != null ? _b : null;
        this.max = (_c = selectedUnit.max) != null ? _c : null;
    ...
    get displayUnit() {
      ...
      if ((_a2 = this.data) == null ? void 0 : _a2.unit) {
        return (_b = this.data) == null ? void 0 : _b.unit;
      }
      if (this.default) {
        return this.default;
      }
    ...
    render() {
      ...
      if (this.variant === "text") {
        ...
        <div style="display:flex;gap:0 8px">
          <p>${((_a2 = this.data) == null ? void 0 : _a2.magnitude) || "-"}</p>
          <p>${this.hideunit ? "" : ((_b = this.data) == null ? void 0 : _b.unit) || "-"}</p>
        </div>
      </div>`;
      }
      return html`
      <sl-input
        ...
        type="number"
        @sl-input=${this.handleInput}
        .value=${((_e = (_d = this.data) == null ? void 0 : _d.magnitude) == null ? void 0 : _e.toString()) || ""}
        placeholder=${this.placeholder}
        autocomplete=${this.autocomplete ? "on" : "off"}
      ></sl-input>
      <sl-select
      ...
      <p class="print-only">${((_f = this.data) == null ? void 0 : _f.magnitude) || "-"}</p>
    `;
    }
  };
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbQuantity.prototype, "autocomplete", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbQuantity.prototype, "hoist", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbQuantity.prototype, "disabled", 2);
  __decorateClass([
    property({ type: Number, reflect: true })
  ], MbQuantity.prototype, "step", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbQuantity.prototype, "placeholder", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbQuantity.prototype, "id", 2);
  __decorateClass([
    property({ type: Boolean })
  ], MbQuantity.prototype, "hideicon", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbQuantity.prototype, "enablesingleunit", 2);
  __decorateClass([
    state()
  ], MbQuantity.prototype, "units", 2);
  __decorateClass([
    query("sl-input")
  ], MbQuantity.prototype, "inputElement", 2);
  __decorateClass([
    query("sl-select")
  ], MbQuantity.prototype, "selectElement", 2);
  ...
  __decorateClass([
    property({ type: Number, reflect: true })
  ], MbUnit.prototype, "max", 2);
  __decorateClass([
    property({ type: Number, reflect: true })
  ], MbUnit.prototype, "min", 2);
  ...
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbDateTime.prototype, "max", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbDateTime.prototype, "min", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbDateTime.prototype, "time", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbDateTime.prototype, "dvdatetime", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbDateTime.prototype, "required", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbDateTime.prototype, "disabled", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbDateTime.prototype, "id", 2);
  __decorateClass([
    event("mb-input")
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.BXPHLFH5.js
...
`;
  ...
  // node_modules/@shoelace-style/shoelace/dist/chunks/chunk.4RYHHWIR.js
  ...
  var MbCheckBox = class extends EhrElement {
    ...
    reportValidity() {
      var _a2;
      const checked = (_a2 = this.shadowRoot) == null ? void 0 : _a2.querySelector("sl-checkbox");
  ...
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbCheckBox.prototype, "id", 2);
  MbCheckBox = __decorateClass([
    customElement("mb-checkbox")
  ], MbCheckBox);

  // src/medblocks/proportion/MbProportion.ts
  var MbProportion = class extends EhrElement {
    ...
    getText() {
      var _a2, _b, _c;
      if ((_a2 = this.data) == null ? void 0 : _a2.numerator) {
        if (this.type === "percent") {
          return `${(_b = this.data) == null ? void 0 : _b.numerator} %`;
        }
        return (_c = this.data) == null ? void 0 : _c.numerator;
      }
      return "-";
    }
    render() {
  ...
  __decorateClass([
    property({ type: Object })
  ], MbProportion.prototype, "data", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbProportion.prototype, "required", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbProportion.prototype, "autocomplete", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbProportion.prototype, "hoist", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbProportion.prototype, "step", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbProportion.prototype, "disabled", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbProportion.prototype, "placeholder", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbProportion.prototype, "id", 2);
  __decorateClass([
    property({ type: Boolean })
  ], MbProportion.prototype, "hideunit", 2);

  // src/medblocks/proportion/percent.ts
  var MbPercent = class extends MbProportion {
    constructor() {
      super(...arguments);
      this.type = "percent";
      this.min = "0";
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbTextSelect.prototype, "disabled", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbTextSelect.prototype, "hoist", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbTextSelect.prototype, "nonclearable", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbTextSelect.prototype, "placeholder", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbTextSelect.prototype, "id", 2);
  __decorateClass([
    state()
  ...
  var MbInputMultiple = class extends EhrElement {
    ...
    render() {
      ...
      if (this.variant === "text") {
        return html`<div>
        ${this._label()}
        <p>${((_a2 = this.data) == null ? void 0 : _a2.join(", ")) || "-"}</p>
      </div>`;
      }
      return html`
      ...
      <div class="tag-container">
        ${(_b = this.data) == null ? void 0 : _b.map((s6, i5) => html`<sl-tag
              id=${`${this.id}_tag${i5}`}
              variant="neutral"
              size=${this.variant === "small" ? "small" : "medium"}
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbInputMultiple.prototype, "hidehelp", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbInputMultiple.prototype, "placeholder", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbInputMultiple.prototype, "id", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbInputMultiple.prototype, "required", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbInputMultiple.prototype, "autocomplete", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbInputMultiple.prototype, "disabled", 2);
  __decorateClass([
    state()
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbDuration.prototype, "autocomplete", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbDuration.prototype, "disabled", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbDuration.prototype, "hidelabel", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbDuration.prototype, "min", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbDuration.prototype, "placeholder", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbDuration.prototype, "id", 2);
  __decorateClass([
    state()
  ...
  // src/medblocks/proportion/proportion.ts
  var MbPercent2 = class extends MbProportion {
    constructor() {
      super(...arguments);
      this.type = "unitary";
      this.min = "0";
  ...
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbPercent2.prototype, "type", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbPercent2.prototype, "min", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbPercent2.prototype, "max", 2);
  MbPercent2 = __decorateClass([
    customElement("mb-proportion")
  ], MbPercent2);

  // src/medblocks/count/count.ts
  var MbCount = class extends EhrElement {
    constructor() {
      super(...arguments);
      this.label = "";
      this.placeholder = "";
  ...
  __decorateClass([
    property({ type: Number })
  ], MbCount.prototype, "data", 2);
  __decorateClass([
    property({ type: String })
  ], MbCount.prototype, "label", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbCount.prototype, "placeholder", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbCount.prototype, "id", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbCount.prototype, "required", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbCount.prototype, "autocomplete", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbCount.prototype, "disabled", 2);
  __decorateClass([
    property({ type: Number, reflect: true })
  ], MbCount.prototype, "max", 2);
  __decorateClass([
    property({ type: Number, reflect: true })
  ], MbCount.prototype, "min", 2);
  __decorateClass([
    event("mb-input")
  ], MbCount.prototype, "_mbInput", 2);
  MbCount = __decorateClass([
    customElement("mb-count")
  ], MbCount);

  // src/medblocks/multimedia/mediaFunction.ts
  function createUUID() {
  ...
  // src/medblocks/multimedia/multimedia.ts
  var MbMultimedia = class extends EhrElement {
    constructor() {
      super(...arguments);
      this.data = void 0;
      this.label = "";
    ...
    async _handleChange(e6) {
      ...
      const file = (_a2 = element.files) == null ? void 0 : _a2[0];
      if (((_b = e6.target) == null ? void 0 : _b.value) === "") {
        this.data = void 0;
      } else if (file) {
        if (this.base64) {
          ...
          reader.onload = (event2) => {
            var _a3;
            base64Data = (_a3 = event2.target) == null ? void 0 : _a3.result;
            this.data = {
              data: base64Data,
              mediatype: file == null ? void 0 : file.type,
              alternatetext: file == null ? void 0 : file.name,
    ...
    async handleInput() {
      ...
      this.loading = true;
      if (this.base64) {
        this.src = (_a2 = this.data) == null ? void 0 : _a2.data;
      } else {
        try {
          const axios = this.axios ? this.axios : this._parentAxios;
          const downloadedFile = await this.plugin.storageAPI.download({
            axios,
            key: (_c = (_b = this.data) == null ? void 0 : _b._root) == null ? void 0 : _c.split("///")[1]
          });
    ...
    render() {
      ...
      ${((_a2 = this.data) == null ? void 0 : _a2.alternatetext) || ""}
      ${this.loading ? html` <p>
            <img
              alt=""
              width="200"
  ...
  __decorateClass([
    property({ type: Object })
  ], MbMultimedia.prototype, "data", 2);
  __decorateClass([
    property({ type: String })
  ], MbMultimedia.prototype, "src", 2);
  __decorateClass([
    property({ type: String })
  ], MbMultimedia.prototype, "label", 2);
  __decorateClass([
    property({ type: String })
  ], MbMultimedia.prototype, "parentAxiosKey", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbMultimedia.prototype, "required", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbMultimedia.prototype, "loading", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbMultimedia.prototype, "base64", 2);
  __decorateClass([
    property({ type: Object })
  ], MbMultimedia.prototype, "axios", 2);
  __decorateClass([
    property({ type: Object })
  ], MbMultimedia.prototype, "plugin", 2);
  __decorateClass([
    watch("data")
  ], MbMultimedia.prototype, "getSrc", 1);
  MbMultimedia = __decorateClass([
    customElement("mb-multimedia")
  ], MbMultimedia);

  // src/medblocks/codedtext/search-multiple.ts
  var MbSearchMultiple = class extends MbSearchAbstract {
    constructor() {
      super(...arguments);
      this.multiple = true;
      this.value = {};
    ...
    get _hasValue() {
      var _a2, _b;
      return !!(((_a2 = this == null ? void 0 : this.value) == null ? void 0 : _a2.value) && ((_b = this == null ? void 0 : this.value) == null ? void 0 : _b.code));
    }
    get _display() {
      var _a2;
      return this._hasValue ? (_a2 = this.value) == null ? void 0 : _a2.value : void 0;
    }
    get _code() {
      var _a2;
      return this._hasValue ? (_a2 = this.value) == null ? void 0 : _a2.code : void 0;
    }
    handleClear(tagIndex) {
      if (!this.disabled) {
        this.data = this.data.filter((_2, i5) => i5 !== tagIndex);
    ...
    render() {
      ...
      if (this.variant === "text") {
        ...
        ${this._label()}
        <p>
          ${Array.isArray(this == null ? void 0 : this.data) ? (_a2 = this.data) == null ? void 0 : _a2.map((item) => this.getDisplay(item)).join(", ") : ""}
        </p>
      </div>`;
      }
      return html`
  ...
  __decorateClass([
    property({ type: Boolean })
  ], MbSearchMultiple.prototype, "multiple", 2);
  __decorateClass([
    state()
  ], MbSearchMultiple.prototype, "value", 2);
  MbSearchMultiple = __decorateClass([
    customElement("mb-search-multiple")
  ], MbSearchMultiple);

  // node_modules/lit-html/directives/unsafe-html.js
  var previousValues2 = new WeakMap();
  ...
  // src/medblocks/repeat/repeatableSimple.ts
  var MbRepeatable = class extends Repeatable {
    constructor() {
      super(...arguments);
      this.css = "";
    }
    ...
    render() {
      ...
      ${[...Array(this.count - 1)].map((_2, i5) => {
        var _a2;
        return html`${unsafeHTML(this.replacePath((_a2 = this.slotNode) == null ? void 0 : _a2.outerHTML, i5 + 1))}`;
      })}
  ...
  ], MbRepeatable.prototype, "assignedNodes", 2);
  __decorateClass([
    state()
  ], MbRepeatable.prototype, "slotNode", 2);
  __decorateClass([
    state()
  ], MbRepeatable.prototype, "observer", 2);
  __decorateClass([
    event("mb-disconnect")
  ], MbRepeatable.prototype, "_mbDisconnect", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbRepeatable.prototype, "css", 2);
  MbRepeatable = __decorateClass([
    customElement("mb-repeatable-simple")
  ], MbRepeatable);

  // src/medblocks/repeat/repeatableHeadless.ts
  var MbRepeatableHeadless = class extends Repeatable {
  };
  ...
  `;
  MbRepeatableHeadless = __decorateClass([
    customElement("mb-repeatable-headless")
  ], MbRepeatableHeadless);

  // src/medblocks/suggestionWrapper.ts
  var SuggestWrapper = class extends LitElement {
    constructor() {
      super(...arguments);
      this.suggestions = [];
      this.global = false;
  ...
  __decorateClass([
    event("mb-suggestion")
  ], SuggestWrapper.prototype, "_suggestionEvent", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], SuggestWrapper.prototype, "path", 2);
  __decorateClass([
    property({ type: Array })
  ], SuggestWrapper.prototype, "suggestions", 2);
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], SuggestWrapper.prototype, "global", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], SuggestWrapper.prototype, "label", 2);
  SuggestWrapper = __decorateClass([
    customElement("mb-suggest")
  ], SuggestWrapper);

  // src/medblocks/hide.ts
  var MbHide = class extends LitElement {
    constructor() {
      super(...arguments);
      this.show = false;
    }
  ...
  __decorateClass([
    property({ type: Boolean, reflect: true })
  ], MbHide.prototype, "show", 2);
  __decorateClass([
    property({ type: String, reflect: true })
  ], MbHide.prototype, "path", 2);
  MbHide = __decorateClass([
